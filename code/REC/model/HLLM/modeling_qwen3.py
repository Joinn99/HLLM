...
class Qwen3Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        attention_interface = compute_flash_attention
        ...
        attn_output = attention_interface(
            ...
            # scaling=self.scaling,         # Set to -0.5 in transformers (<=4.51)
            # sliding_window=self.sliding_window,  # diff with Llama      # Set to false in Qwen3-0.6B
            # **kwargs,
        )
